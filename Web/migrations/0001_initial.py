# Generated by Django 3.2 on 2023-07-16 16:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.SmallIntegerField(choices=[(1, '激活'), (0, '删除')], default=1, verbose_name='用户状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.SmallIntegerField(choices=[(1, '激活'), (0, '删除')], default=1, verbose_name='用户状态')),
                ('status', models.SmallIntegerField(choices=[(1, '待执行'), (2, '进行中'), (3, '已完成'), (4, '失败')], default=1, verbose_name='状态')),
                ...
                ('create_datetime', models.DateTimeField(auto_now_add=True, verbose_name='订单生成时间')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Web.customer', verbose_name='客户')),
            ],
            options={
